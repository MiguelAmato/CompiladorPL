/* Generated By:JavaCC: Do not edit this line. ASTS_DTokenManager.java */
package c_ast_descendente;
import asint.SintaxisAbstractaEval.*;
import asint.ClaseSemanticaEval;

/** Token Manager. */
public class ASTS_DTokenManager implements ASTS_DConstants
{
...
"\46\46", null, null, "\173", "\175", "\73", "\133", "\135", "\136", "\54", "\50", 
"\51", "\46", "\100", "\75", "\53", "\55", "\56", "\76", "\74", "\52", "\57", "\45", };
...
/** Constructor. */
public ASTS_DTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public ASTS_DTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
