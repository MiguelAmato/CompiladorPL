      ...
      switch (CUP$Asts$act_num)
		...
		Exp exp = (Exp)((java_cup.runtime.Symbol) CUP$Asts$stack.peek()).value;
		 RESULT = exp; 
          ...
          case 80: // E7 ::= opnd 
            {
              Exp RESULT =null;
		Exp op = (Exp)((java_cup.runtime.Symbol) CUP$Asts$stack.peek()).value;
		 RESULT = op; 
              CUP$Asts$result = parser.getSymbolFactory().newSymbol("E7",38, RESULT);
            }
          return CUP$Asts$result;
		...
		StringLocalizado op = (StringLocalizado)((java_cup.runtime.Symbol) CUP$Asts$stack.peek()).value;
		 RESULT = new StringLocalizado(">", op.fila(), op.col()); 
              CUP$Asts$result = parser.getSymbolFactory().newSymbol("op_relacional",40, RESULT);
            }
          return CUP$Asts$result;
		...
		StringLocalizado op = (StringLocalizado)((java_cup.runtime.Symbol) CUP$Asts$stack.peek()).value;
		 RESULT = new StringLocalizado("*", op.fila(), op.col()); 
              CUP$Asts$result = parser.getSymbolFactory().newSymbol("op_nivel4",41, RESULT);
            }
          return CUP$Asts$result;
		...
		StringLocalizado op = (StringLocalizado)((java_cup.runtime.Symbol) CUP$Asts$stack.peek()).value;
		 RESULT = new StringLocalizado("-", op.fila(), op.col()); 
              CUP$Asts$result = parser.getSymbolFactory().newSymbol("op_nivel5",42, RESULT);
            }
          return CUP$Asts$result;
		...
		StringLocalizado num = (StringLocalizado)((java_cup.runtime.Symbol) CUP$Asts$stack.peek()).value;
		 RESULT = (Exp) sem.literal_ent(num.str()).ponFila(num.fila()).ponCol(num.col()); 
              CUP$Asts$result = parser.getSymbolFactory().newSymbol("opnd",39, RESULT);
            }
          return CUP$Asts$result;
